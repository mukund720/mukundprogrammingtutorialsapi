...
class CourseLearningTopicController extends ResourceController
{
    protected $modelName = 'App\Models\CourseLearningTopicModel'; // Replace ModelName with your specific model class
