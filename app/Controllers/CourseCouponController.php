...
class CourseCouponController extends ResourceController
{
    protected $modelName = 'App\Models\CourseCouponModel'; // Replace ModelName with your specific model class
