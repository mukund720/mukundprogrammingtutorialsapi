...
class CourseTopicController extends ResourceController
{
    protected $modelName = 'App\Models\CourseTopicModel'; // Replace ModelName with your specific model class
