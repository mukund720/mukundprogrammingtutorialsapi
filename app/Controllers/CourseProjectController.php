...
class CourseProjectController extends ResourceController
{
    protected $modelName = 'App\Models\CourseProjectModel'; // Replace ModelName with your specific model class
