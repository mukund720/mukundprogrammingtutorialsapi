...
class CourseCertificateController extends ResourceController
{
    protected $modelName = 'App\Models\CourseCertificateModel'; // Replace ModelName with your specific model class
