...
class CourseResourceController extends ResourceController
{
    protected $modelName = 'App\Models\CourseResourceModel'; // Replace ModelName with your specific model class
