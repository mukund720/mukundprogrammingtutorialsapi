...
class CourseLearningController extends ResourceController
{
    protected $modelName = 'App\Models\CourseLearningModel'; // Replace ModelName with your specific model class
