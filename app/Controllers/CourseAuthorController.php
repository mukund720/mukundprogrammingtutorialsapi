...
class CourseAuthorController extends ResourceController
{
    protected $modelName = 'App\Models\CourseAuthorModel'; // Replace ModelName with your specific model class
