...
class CoursePerkBenefitController extends ResourceController
{
    protected $modelName = 'App\Models\CoursePerkBenefitModel'; // Replace ModelName with your specific model class
